...
public class ElementServiceImpl implements ElementService {
    ...
    @Override
    public List<Element> findElementsByElementNameContains(String subStr) {
        return elementRepository.findElementsByElementNameContains(subStr);
    }

    @Override
    public Element findFirstByOrderByElementNameAsc() {
        return elementRepository.findFirstByOrderByElementNameAsc();
    }
}
